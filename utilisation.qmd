...
### Voici également une brève présentation de Git et GitHub à laquelle j'ai contribuée dans le cadre d'un cours offert sur [EDU*lib*](https://catalogue.edulib.org/fr/cours/umontreal-isds/)*.*

::: g-col-12
<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vQulOb6UhpZP_cGB6ArZD8Pwahk5YuxVXcVJwFdjWGODVZb4mdxckEPlLoVBAmVoxt-ZXGv2m__1KvR/embed?start=false&amp;loop=false&amp;delayms=3000" frameborder="0" width="100%" height="500" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
:::
